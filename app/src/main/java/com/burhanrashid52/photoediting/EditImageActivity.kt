...
class EditImageActivity : BaseActivity(), OnPhotoEditorListener, View.OnClickListener,
    ...
    private var mBtnGallery : Button? = null
    private var mBtnPhoto : Button? = null
    private var mViewLanding : ConstraintLayout? = null
    ...
    private fun initViews() {
        ...
        mViewLanding = findViewById(R.id.viewLanding)
        ...
        mPhotoEditorView?.visibility = View.INVISIBLE
        mTxtCurrentTool?.visibility = View.INVISIBLE
        mRvTools?.visibility = View.INVISIBLE
        mRvFilters?.visibility = View.INVISIBLE
        imgUndo?.visibility = View.INVISIBLE
        imgRedo?.visibility = View.INVISIBLE
        imgCamera?.visibility = View.INVISIBLE
        imgGallery?.visibility = View.INVISIBLE
        imgSave?.visibility = View.INVISIBLE
    ...
    companion object {
        ...
        internal const val CAMERA_REQUEST = 52
        internal const val PICK_REQUEST = 53
        const val ACTION_NEXTGEN_EDIT = "action_nextgen_edit"
        const val PINCH_TEXT_SCALABLE_INTENT_KEY = "PINCH_TEXT_SCALABLE"
    }

    private  fun makeVisiblity(){
        mViewLanding?.visibility = View.GONE
